...
})({"9gMqX":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "c65a8be0567d2a80";
"use strict";
...
},{}],"eDOIG":[function(require,module,exports,__globalThis) {
...
function start(event) {
    ...
    const timer = setTimeout(()=>{
        const promiseIds = Array.from({
            length: Number(amount.value)
        }, (_, index)=>index);
        // [0, 1, 2, 3, 4,].length() = 5
        let i = 0;
        const enqueuePromise = ()=>{
            ...
            const currentPromise = new Promise((resolve, reject)=>{
                const promiseTimer = setTimeout(()=>{
                    ...
                    if (shouldResolve) resolve({
                        index: i,
                        result: `Promise ${promiseIds[i]} resolved`
                    });
                    else reject({
                        index: i,
                        result: `Promise ${promiseIds[i]} rejected`
                    });
                    i++;
            ...
            currentPromise.then((data)=>{
                (0, _notiflixDefault.default).Notify.success(`Result :>> ${data.result}`);
                if (promiseIds[data.index + 1] !== undefined) enqueuePromise();
            }).catch((data)=>{
                (0, _notiflixDefault.default).Notify.failure(`Result :>> ${data.result}`);
                if (promiseIds[data.index + 1] !== undefined) enqueuePromise();
            });
        };
        enqueuePromise();
...
},{}]},["9gMqX","eDOIG"], "eDOIG", "parcelRequire94c2")

//# sourceMappingURL=task-3.567d2a80.js.map
