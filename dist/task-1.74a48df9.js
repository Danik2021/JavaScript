...
})({"5WMhi":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "9de9d10974a48df9";
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dUIss":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function fetchBreeds() {
    ...
    fetch(`${(0, _task1.catsByBreedsURL)}`).then((r)=>r.json()).then((cats)=>{
        ...
        cats.forEach(({ breeds, id })=>{
            (0, _task1.refs).select.insertAdjacentHTML("beforeend", `<option value="${id}">${breeds[0].name}</option>`);
        });
        (0, _task1.refs).select.addEventListener("change", addCat);
    }).catch((error)=>{
        (0, _notiflixDefault.default).Notify.failure("Failed to fetch cats: " + error.message);
        throw error;
    });
}
function addCat(e) {
    (0, _task1.refs).catsCont.innerHTML = "";
